package com.lorenzosprenger.agendador_horarios.services;

import com.lorenzosprenger.agendador_horarios.infrastructure.entity.Agendamento;
import com.lorenzosprenger.agendador_horarios.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    public Agendamento salvarAgendamento(Agendamento agendamento) {
        ...
        if(Objects.nonNull(agendados)) {
            throw new RuntimeException("Hórario já está preenchido");
        }else {
